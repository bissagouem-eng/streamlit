...
- [pr-creation/](processes/pr-creation/) - PR creation workflow, labeling, branch naming, templates, writing style
...
3. If adding a new directory, add a description above.
