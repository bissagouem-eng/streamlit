...
def test_headers_snapshot_match(
    ...
    # Test header with help
    header_with_help = get_heading(themed_app, "header with help")
...
def test_headers_hovered_snapshot_match(
    ...
    # Test header with help and anchor on hover
    header_with_help = get_heading(themed_app, "header with help")
    ...
    header_hidden = get_heading(themed_app, "header with help and hidden anchor")
...
def test_subheaders_snapshot_match(
    ...
    # Test subheader with help
    subheader_with_help = get_heading(themed_app, "Subheader with help")
...
def test_subheaders_hovered_snapshot_match(
    ...
    # Test subheader with help and anchor on hover
    subheader_with_help = get_heading(themed_app, "Subheader with help")
    ...
    subheader_hidden = get_heading(themed_app, "Subheader with help and hidden anchor")
...
def test_help_tooltip_works(app: Page):
    ...
    header_with_help = get_heading(app, "header with help")
    expect_help_tooltip(app, header_with_help, tooltip_text)

    subheader_with_help = get_heading(app, "Subheader with help")
