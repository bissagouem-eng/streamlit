...
@pytest.mark.parametrize(
    ("has_text", "alignment_value"),
    [
        (r"Left aligned text \(default\)", "left"),
        ("Center aligned text", "center"),
        ("Right aligned text", "right"),
        (
            "Justified text. This is a longer text to demonstrate justification.",
            "justify",
        ),
    ],
)
def test_text_text_alignment(
    ...
    text_element = get_text(app, has_text)
