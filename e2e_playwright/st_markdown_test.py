...
def test_help_tooltip_works(app: Page):
    ...
    # Get the first markdown element with help tooltip
    markdown_with_help = get_markdown(app, "This markdown is awesome!")
...
def test_markdown_width_examples(
    ...
    # Test content width
    markdown_content = get_markdown(themed_app, "Content width:")
    ...
    markdown_200px = get_markdown(themed_app, "Fixed width (200px):")
    markdown_200px.scroll_into_view_if_needed()
    assert_snapshot(markdown_200px, name="st_markdown-width_200px")

    # Test stretch width
    markdown_stretch = get_markdown(themed_app, "Stretch width:")
...
def test_caption_width_examples(
    ...
    # Test content width
    caption_content = get_caption(themed_app, "caption with content-based width")
    ...
    caption_300px = get_caption(themed_app, "caption with a fixed width of 300 pixels")
    caption_300px.scroll_into_view_if_needed()
    assert_snapshot(caption_300px, name="st_caption-width_300px")

    # Test stretch width
    caption_stretch = get_caption(themed_app, "caption that stretches to fill")
